...
; صفرٌ عن قصد، والتعليق السابق كان يصف عكس ما يفعله السطر: كان يقول
; إننا «نطلب هامشًا معقولًا» بينما القيمة لا تطلب شيئًا.
;
; و‏Inno يحسب حجم الملفات المشحونة وحده ويرفض التثبيت إن ضاق القرص،
; فلا حاجة لتكراره هنا. والنموذج (~1.7GB) ليس من إنتاج المثبِّت: يُنزَّل
; لاحقًا بإذن المستخدم إلى مجلده هو — وقد يكون على قرصٍ آخر أصلًا،
; فاشتراط مساحته هنا يمنع تثبيتًا سليمًا.
